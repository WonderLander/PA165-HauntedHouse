 ...
 */
@WebFilter(urlPatterns = {"/user/*","/comments/house/*","/ability/delete/*","/bogeyman/delete/*","/bogeyman/edit","/bogeyman/edit/*","/houses/edit","/houses/create","/houses/delete/*","/houses/edit/*"})
